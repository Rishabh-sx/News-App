...
public interface NewsDao {
    ...
    @Query("SELECT COUNT(*) FROM article WHERE url = :articleUrl AND " +
    ...
    @Query("SELECT * FROM article WHERE headlineType =:headlineType")
    ...
    @Query("DELETE FROM article WHERE headlineType =:headlineType")
    void delAllArticlesByHeadline(String headlineType);
}